...
const PALETTES = [
  // dawn
  {
    ...
    oceanDeep: '#4A81A0', oceanShallow: '#9DCCC4', oceanSparkle: '#FBE9C8', foam: '#F9F1E4',
    sandLit: '#F0D0A2', sandShadow: '#C9A176', cloudLit: '#FFEED6', cloudShadow: '#CFA6B4',
    rockLit: '#C0A08D', rockShadow: '#84707A', hazeColor: '#EEDCC6',
    grassLit: '#8FB07E', grassShadow: '#5F7A62', bird: '#6A5F63',
    starColor: '#E8D5C0', lanternGlow: '#FFAE5C',
    washA: '#F2B0A0', washB: '#F8DCA8',
  },
  // midday
  {
    skyZenith: '#3F84CE', skyHorizon: '#E7F4EA', sunCore: '#FFFDF4', sunHalo: '#FFF3D3',
    oceanDeep: '#2A7DA6', oceanShallow: '#70D2C2', oceanSparkle: '#FFF6DA', foam: '#FAF7EC',
    sandLit: '#F6DFAC', sandShadow: '#CBA47A', cloudLit: '#FFF9EC', cloudShadow: '#8FA8D0',
    rockLit: '#CFA987', rockShadow: '#8F736E', hazeColor: '#E2F0EA',
    grassLit: '#7FB868', grassShadow: '#567B58', bird: '#5A5560',
  ...
  // golden hour
  {
    ...
    oceanDeep: '#42648C', oceanShallow: '#86AFA2', oceanSparkle: '#FFD98F', foam: '#FBE9D3',
    sandLit: '#F5C289', sandShadow: '#B08066', cloudLit: '#FFDCA0', cloudShadow: '#C27E8E',
    rockLit: '#E0A470', rockShadow: '#85606C', hazeColor: '#F6CB9F',
    grassLit: '#B0A96E', grassShadow: '#6E6B55', bird: '#6A4E56',
